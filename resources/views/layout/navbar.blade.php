<header class="bg-[#FFFAF2]">
    <nav class="container relative flex py-5 items-center justify-between ">
      <a href="">
        <img src="assets/gambar/logo-dark.svg" alt="">
      </a>
      ...
      <div class="flex items-center space-x-5 hidden md:flex">
        <a href="/login" class="outline outline-2 py-3 px-8 text-[#FF994F] rounded-full">Log in</a>
        <a class="bg-[#FF994F] py-3 px-8 text-white rounded-full">Registration</a>
      </div>

      <a href="#" class="hamburger md:hidden">
        <img src="assets/gambar/hamburger.svg" alt="">
      </a>
