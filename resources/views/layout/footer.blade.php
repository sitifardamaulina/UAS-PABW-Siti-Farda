    ...
    <div class="container">
      <div class="grid lg:grid-cols-12 grid-cols-5">
        <div class="lg:col-span-4 col-span-5 sm:pb-5 lg:pb-0">
          <a href="/">
            <img src="assets/gambar/logo-white.svg" alt=""/>
            ...
            <ul class="flex mt-10 gap-5 justify-center md:justify-start">
              <li class="mr-2">
                <img src="assets/gambar/facebook logo.svg" alt="">
              </li>
              <li class="mr-2">
                <img src="assets/gambar/Vector.svg" alt="">
              </li>
              <li class="mr-2">
                <img src="assets/gambar/linkedin logo.svg" alt="">
              </li>
              <li class="mr-2">
                <img src="assets/gambar/instagram logo.svg" alt="">
              </li>
            </ul>
          </a>
        </div>
        ...
        <div class="lg:col-span-3 col-span-5 mt-4 lg:mt-0">
          ...
          <form action="?">
            <div class="w-full rounded-3xl bg-white overflow-hidden flex pr-3">
              ...
              <img src="assets/gambar/panah email.svg" alt="">
            </div>
          </form>
        </div>
      </div>
